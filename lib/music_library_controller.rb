class MusicLibraryController
  ...
  def list_songs
#prints all songs in the music library in a numbered list (alphabetized by artist name
    songs_sorted_by_name = Song.all.sort_by do |song| #returns an array of songs sorted by song name
      song.name
    end
